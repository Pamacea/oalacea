/**
 * DIALOG - Warhammer 40K Brutal Style
 * Angular borders, dark background, minimal animations
 */
...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-imperium-black/80 backdrop-blur-sm",
        className
      )}
      {...props}
    />
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 text-center sm:text-left border-b-2 border-imperium-steel-dark pb-4", className)}
      {...props}
    />
  )
}
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-4 sm:flex-row sm:justify-end pt-4 mt-4 border-t-2 border-imperium-steel-dark",
        className
      )}
      {...props}
    >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("font-display text-xl uppercase tracking-wider text-imperium-crimson", className)}
      {...props}
    />
  )
}
